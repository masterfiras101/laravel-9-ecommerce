...
class ProductContreller extends Controller
{
    ...
    public function store(ProductFormRequest $request){
        ...
        $product = $category->products()->create([
            ...
            'small_descriptioin'=> $validatedData['small_descriptioin'],
            'descriptioin'=> $validatedData['descriptioin'],
    ...
    public function destroy(int $product_id)
    {
        ...
        $product->delete();
        return redirect('admin/products')->with('message','product is Deleted with its image');

    }


    public function updateproduct_quant(Request $request ,$prod_color_id)
    {
